    ...
    <>
      ...
      <div className="flex justify-center gap-4 mt-8">
        <a
          ...
          className={`px-4 py-2 bg-[var(--green)] text-white rounded ${currentPage <= 1 ? "opacity-50 pointer-events-none" : ""
            }`}
        >
          Previous
        </a>
        ...
        <a
          ...
          className={`px-4 py-2 bg-[var(--green)] text-white rounded ${currentPage >= totalPages ? "opacity-50 pointer-events-none" : ""
            }`}
        >
          Next
        </a>
