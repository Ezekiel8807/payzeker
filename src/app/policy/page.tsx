      ...
      <div className="px-5 sm:px-10 md:px-20 py-5 sm:py-10 text-gray-800 leading-relaxed">
        ...
        <ul>
          ...
          <li>
            <p>
              ...
              in this Agreement) refers to Payzeker.
            </p>
          </li>
          <li>
            <p>
          ...
          <li>
            <p>
              <strong>Website</strong> refers to Payzeker, accessible from{" "}
              <a
                href="https://www.payzeker.com"
                rel="external nofollow noopener"
                target="_blank"
              >
                https://www.payzeker.com
              </a>
            </p>
          </li>
          <li>
        ...
        <ul>
          <li>
            ...
            <a
              href="https://www.payzeker.com/contact"
              rel="external nofollow noopener"
              target="_blank"
            >
              https://www.payzeker.com/contact
            </a>
          </li>
        </ul>
      </div>
